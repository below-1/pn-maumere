    ...
    <div class="navbar navbar-dark bg-primary">
      <div class="container-xl">
        <ul class="navbar-nav">
            ...
            <div class="dropdown-menu">
              <div class="dropdown-menu-columns">
                <div class="dropdown-menu-column">
                  <a 
                    class="dropdown-item" 
                    href="<?= site_url('/article/pengantar-ketua-pengadilan') ?>">
                    Pengantar Ketua Pengadilan
                  </a>
                  <a 
                    class="dropdown-item" 
                    href="<?= site_url('/article/visi-misi') ?>">
                    Visi dan Misi
                  </a>
                  <a 
                    class="dropdown-item" 
                    href="<?= site_url('/profil-pengadilan') ?>">
                    Profil Pengadilan 
                  </a>
                  <a class="dropdown-item" 
                    href="<?= site_url('/profil-hakim-pegawai') ?>">
                    Profil Hakim dan Pegawai
                  </a>
                  <a class="dropdown-item" 
                    href="<?= site_url('/article/kepaniteraan') ?>">
                    Kepaniteraan
                  </a>
                  <a class="dropdown-item" 
                    href="<?= site_url('/article/sekretariat') ?>">
                    Kesekretariatan
                  </a>
                  <a class="dropdown-item"
                    href="<?= site_url('/article/sekretariat') ?>">
                    Sistem Pengolaan Pengadilan
                  </a>
                  <a class="dropdown-item" 
                    href="<?= route_to('survey_pelayanan_publik') ?>" >
          ...
          <li class="nav-item">
            <a class="nav-link" href="/article/kontak" >
