            ...
            <div class="dropdown-menu">
              <div class="dropdown-menu-columns">
                <div class="dropdown-menu-column">
                  <a class="dropdown-item" href="/admin/article/new?tag=berita" >
                    Berita
                  </a>
                  <a class="dropdown-item" href="/admin/article/new?tag=penguman" >
                    Pengumuman
                  </a>
                  <a class="dropdown-item" href="/admin/article/new" >
                    Lainnya
                  </a>
                </div>
              </div>
